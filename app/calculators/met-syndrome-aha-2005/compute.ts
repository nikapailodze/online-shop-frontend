...
export function computeMetAHA2005({
  ...
  sex: Sex;
  waistIn: string;
  tgMgdl: string; onTgRx: boolean;
  hdlMgdl: string; onHdlRx: boolean;
  sbp: string; dbp: string; onBpRx: boolean;
  fpgMgdl: string; onGluRx: boolean;
}) {

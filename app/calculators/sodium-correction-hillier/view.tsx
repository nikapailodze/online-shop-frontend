...
export default function SodiumCorrectionHillierView() {
  ...
  const result = useMemo(
    () => computeSodiumCorrectionHillier({ measuredNa, glucoseMgdl }),
            ...
            <div className={styles.stack}>
              ...
              <Collapsible title="Equations used">
                <div className={styles.small}>
                  <p>
                    <strong>Corrected Sodium</strong> = Measured Sodium + 0.024
                    × (Glucose − 100)
                  </p>
              ...
              <Collapsible title="References">
                <div className={styles.small}>
                  Hillier TA, Abbott RD, Barrett EJ. Hyponatremia: evaluating
                  the correction factor for hyperglycemia. <em>Am J Med.</em>{" "}
                  1999;106(4):399–403. PMID: 10225241.
                </div>
              </Collapsible>
            </div>
          </SectionCard>
